...
import * as importedModule$0 from "./sources/overlayv2/introspectionSchema.json";
...
export async function getMeshOptions() {
    ...
    const overlayv2Handler = new GraphqlHandler({
        name: "overlayv2",
        config: { "endpoint": "https://api.studio.thegraph.com/query/46086/overlay-v2-subgraph-arbitrum/version/latest" },
        baseDir,
        cache,
        pubsub,
    ...
    overlayv2Transforms[0] = new AutoPaginationTransform({
        apiName: "overlayv2",
